...
The original RJ-PINNs project has evolved into the **Residual Jacobian Framework (RJF)**.

## What is RJF?

**A Residual Jacobian Framework (RJF) for Multi-Objective Optimization.**

🔗 **RJF Repository:**  
https://github.com/dadesso17/RJF

➡️ Please visit the RJF repository for the latest developments and updates.
